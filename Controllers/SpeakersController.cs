...
namespace SacramentMeetingPlanner.Controllers
{
    public class SpeakersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SpeakerID,PlannerID,MemberID,Topic")] Speaker speaker)
        {
            ...
            ViewData["MemberID"] = new SelectList(_context.Member, "MemberId", "FirstName", speaker.MemberID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SpeakerID,PlannerID,MemberID,Topic")] Speaker speaker)
        {
